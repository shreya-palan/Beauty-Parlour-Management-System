...
?>
				<h1><font color="pink"><center>APPOINTMENT REQUESTS</h1></font><br>
				<?php
...
{
?><td><center><font color="blue"><b><?php echo "Approved";?></b></td><?php }
else if($s==2)
{
?><td><center><font color="blue"><b><?php echo "Serviced";?></b></td><?php }
else if($s==3)
{
?><td><center><font color="blue"><b><?php echo "Rejected";?></b></td><?php }?>
