...
{
?>
<div><br><center><font color="pink"><h1><b>EDIT BRAND</font></b></h1><br><br>
<body>
<form action="#" method="post">
<table><font size="4"><tr>
<tr><td><b><font color="white">Brand Name: <input type="text" name="brand" value="<?php echo $row['Brand_name'];?>"></font></b></td></tr>
<tr>
