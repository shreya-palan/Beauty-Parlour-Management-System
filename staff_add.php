...
function Validate() 
{
    ...
    return true;
          ...
          <tr>
          <td><b><font color="white">Last_name</font></b></td>
...
function Validatew() 
{
    ...
    return true;
          ...
          <td><b><font color="white"><input type="radio" name="txt_staff_Gender" id="txt_staff_Gender" value="Male"required>Male</font></b>
		  <b><font color="white"><input type="radio" name="txt_staff_Gender" id="txt_staff_Gender" value="Female"required>Female</font></b></td>
          </tr>
		  <td></td>
          <tr>
          <td><b><font color="white">House_Name</font></b></td>
...
function Validname() 
{
    ...
    return true;
		  ...
		  <tr>
          <td><b><font color="white">District</font></b></td>
		  ...
		  <tr>
          <td><b><font color="white">City</font></b></td>
...
function Validcity() 
{
    ...
    return true;
          ...
          <tr>
          <td><b><font color="white">Mobile</font></b></td>
...
function Validata() 
{
    ...
    return true;
		  ...
		  <td><b><font color="white">Qualification</font></b></td><td>
		  ...
		  <tr>
          <td><b><font color="white">Specialization</font></b></td>
		  ...
		  ?>
		  <tr> <td><b><font color="white">University/College</font></b></td>
          <td><input type="text" name="txt_university" id="txt_university" value="" required></td>
		  <tr>
		  <td><b><font color="white">Year Of Pass</font></b></td>
          <td><input type="year" name="txt_year" id="txt_year" value="" required></td>
		  <tr>
		  <tr>
          <td><b><font color="white">Experience</font></b></td>
...
<span>
          <td><b><font color="white">Confirm Password</font></b></td>
...
<script>
	function check(){
          ...
          <td><b><font color="white">Image</font></b></td>
