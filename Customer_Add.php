...
<html>
<head>
<h1><font color="pink">     CUSTOMER REGISTRATION</h1></font>
</head>
<body>
...
function Validatew() 
{
    ...
    return true;
          ...
          <td>><b><font color="white"><input type="radio" name="txt_Customer_Gender" id="txt_Customer_Gender" value="Male" required>Male</font>
		  <b><font color="white"><input type="radio" name="txt_Customer_Gender" id="txt_Customer_Gender" value="Female" required>Female</font></td>
          </tr>
			<td></td>
          <tr>
...
<script>
	function check(){
          ...
          <td><b><font color="white">Upload Your Photo</font></b></td>
