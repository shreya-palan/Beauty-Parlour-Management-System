...
<html>
<head><center>
<h1><font color="pink"> SERVICE BOOKING</h1></font>
</head>
...
<body>
      <table>
      <tr> <td><font color="white">Name</font></td><td><input type="text" name="slb_Customer_id" id="slb_Customer_id" value="<?php echo $custname; ?>" readonly="readonly">
          <tr>
     ...
     <?php
	  ...
	  $_SESSION['Cat_id']=$x;?>
	<tr>
          <td><b><font color="white">Service</font></b></td>
          ...
          <tr>
          <td><b><font color="white">Appoinment_date</font></b></td>
		  ...
		  <tr>
          <td><b><font color="white">Appoinment_time</font></b></td>
          <td><input type="time" name="time" id="time"  required/></td></tr>
		  <td><b><font color="white">Staff Preferred</font></b></td>
