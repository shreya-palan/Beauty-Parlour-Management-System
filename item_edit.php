...
<div><br><font color="pink"><h1><b>EDIT ITEM</b></font></h1><br><br>
<table>
<tr><td><img src="Uploads/<?php echo $row['Item_image'];?>" alt="" height="160" width="160" style="padding-right: 418px; margin-bottom: 6px; padding-left: 7px; margin-top: -13px;"></font></td></tr>
<tr><td><font color="white">Item Name:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type="text" name="itemname" value="<?php echo $row['Item_name'];?>" /></tr></td>
            <tr><td><font color="white">Brand Name: &nbsp&nbsp&nbsp&nbsp</font>
		  ...
		  ?>
				 ...
				 <tr><td><font color="white">Item Price:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type="text" name="price" value="<?php echo $row['Item_price'];?>" /></font></tr></td>
				 <tr><td><font color="white">Item Image:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  <input type="file" name="Image" value="<?php echo $row['Item_image'];?>" /></font></tr></td>
