...
if(!isset($_SESSION['Reg_id']))
	...
	?>
   <li ><a href='customer_first2.php?uid=<?php echo $_SESSION['Reg_id'];?>'><span>Home</span></a></li>
   ...
   <li class='has-sub'><a href='#'><span>Profile</span></a>
      <ul>
         <li ><a href='Customer_home.php?uid=<?php echo $_SESSION['Reg_id'];?>'><span>View Profile</span></a> </li>
