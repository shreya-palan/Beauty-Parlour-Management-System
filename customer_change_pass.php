...
<td></td>
		...
		<tr>
                                             <td><b><font color="white">Old Password</font></b></td><td><input type="password" name="old" id="txtoldpwd"/></td>
                                         </tr>
                                           <tr>
                                             <td><b><font color="white">New Password</font></b></td><td><input type="password" name="new" id="txtnewpwd" onchange="Validp();"/></td>
                                         </tr>
										 <script>		
function Validp() 
{
    ...
    return true;
                                          ...
                                          <tr>
                                             <td><b><font color="white">Confirm Password</font></b></td><td><input type="password" name="confirm" id="txtconfirmpwd" onchange="check();"/></td>
                                         </tr>
										 <script>
	function check(){
