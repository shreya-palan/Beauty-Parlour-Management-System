...
<td></td>
		...
		<tr>
                                           ...
                                           <tr>
                                             <td><b><font color="white">New Password</b></td><td><input type="password" name="new" id="txtnewpwd" onchange="Validp();"/></font></td>
                                         </tr>
										 <script>		
function Validp() 
{
    ...
    return true;
                                          ...
                                          <tr>
                                             <td><b><font color="white">Confirm Password</b></td><td><input type="password" name="confirm" id="txtconfirmpwd" onchange="check();"/></font></td>
                                         </tr>
										 <script>
	function check(){
